...
'''
תשובה 4
התועלת בלהשתמש בפורמט .parquet:
הפורמט הוא גורם לקובץ להיות דחוס ולכן הם תופסים פחות מקום מהקבצים האחרים שהשתמשנו בהם
הפורמט הוא : columnar format
זה אומר שהוא שומר את הנתונים בצורת עמודות ולא שורות
זה מועיל אם יש נתונים מרובים כמו שיש לנו בגלל שלרוב יש קצת עמודות והרבה שורות
זה טוב לנו במיוחד כי הוא מהיר יותר אם צריך לקרוא עמודות מסוימות כמו אצלנו
אפשר ללכת בו לתאריך מסויים ולעשות פעולות על מה שקרה עד אז- ניהול גירסאות.
